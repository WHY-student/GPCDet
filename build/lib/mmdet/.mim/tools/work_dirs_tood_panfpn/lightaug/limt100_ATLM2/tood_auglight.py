...
train_pipeline = [
    dict(type='LoadImageFromFile', aug=True, light_limt=100),
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=
        '/home/duomeitinrfx/data/tangka_magic_instrument/update/coco/trainaug/',
        pipeline=[
            dict(type='LoadImageFromFile', aug=True, light_limt=100),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
    ...
    val=dict(
        ...
        img_prefix=
        '/home/duomeitinrfx/data/tangka_magic_instrument/update/coco/valaug/',
        pipeline=[
            dict(type='LoadImageFromFile', aug=True, light_limt=100),
            dict(
                type='MultiScaleFlipAug',
...
work_dir = 'work_dirs_tood_panfpn/lightaug/limt100_ATLM2'
auto_resume = False
gpu_ids = [0]
