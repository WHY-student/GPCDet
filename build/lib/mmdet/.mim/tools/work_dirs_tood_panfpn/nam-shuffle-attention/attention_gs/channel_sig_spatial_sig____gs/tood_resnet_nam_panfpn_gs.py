...
train_pipeline = [
    dict(
        type='LoadImageFromFile', aug=False, ratiov=1.0, ratioc=300, limt=100),
...
work_dir = 'work_dirs_tood_panfpn/nam-shuffle-attention/attention_gs/channel_sig_spatial_sig____gs'
auto_resume = False
gpu_ids = [2]
