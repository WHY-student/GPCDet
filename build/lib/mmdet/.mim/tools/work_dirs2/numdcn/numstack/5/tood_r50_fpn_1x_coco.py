...
log_level = 'INFO'
load_from = None
resume_from = '/home/duomeitinrfx/users/pengxl/mmdetection/tools/work_dirs2/numdcn/numstack/5/best_bbox_mAP_epoch_16.pth'
workflow = [('train', 1)]
...
work_dir = 'work_dirs2/numdcn/numstack/5'
auto_resume = False
gpu_ids = [3]
