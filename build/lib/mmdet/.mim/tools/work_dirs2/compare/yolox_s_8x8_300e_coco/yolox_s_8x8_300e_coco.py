...
custom_hooks = [
    ...
    dict(type='SyncNormHook', num_last_epochs=50, interval=10, priority=48),
    dict(
...
interval = 10
evaluation = dict(
    save_best='auto', interval=10, dynamic_intervals=[(350, 1)], metric='bbox')
work_dir = 'work_dirs2/compare/yolox_s_8x8_300e_coco'
auto_resume = False
gpu_ids = [2]
