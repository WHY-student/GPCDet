...
albu_train_transforms = [dict(type='RandomBrightnessContrast', p=0.8)]
train_pipeline = [
    ...
    dict(
        type='Albu',
        transforms=[dict(type='RandomBrightnessContrast', p=0.8)],
        bbox_params=dict(
            type='BboxParams',
            format='pascal_voc',
...
work_dir = 'work_dirs2/aug/augBrightness/p_0.8_2'
auto_resume = False
gpu_ids = [3]
