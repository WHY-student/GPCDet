...
albu_train_transforms = [dict(type='RandomBrightnessContrast', p=0.2)]
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(
        type='Albu',
        transforms=[dict(type='RandomBrightnessContrast', p=0.2)],
        bbox_params=dict(
            type='BboxParams',
            format='pascal_voc',
...
work_dir = 'work_dirs2/aug/augBrightness/p_2_0.2'
auto_resume = False
gpu_ids = [3]
