...
albu_train_transforms = [dict(type='RandomBrightnessContrast', p=0.3)]
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(
        type='Albu',
        transforms=[dict(type='RandomBrightnessContrast', p=0.3)],
        bbox_params=dict(
            type='BboxParams',
            format='pascal_voc',
...
work_dir = 'work_dirs2/ablation/tood_resnet_nam_panfpn_gs_aug'
auto_resume = False
gpu_ids = [3]
