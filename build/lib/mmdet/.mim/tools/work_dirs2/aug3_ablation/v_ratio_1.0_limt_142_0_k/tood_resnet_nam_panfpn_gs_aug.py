...
train_pipeline = [
    dict(type='LoadImageFromFile', ratio=1.0, limt=142),
...
test_pipeline = [
    dict(type='LoadImageFromFile', ratio=1.0, limt=130),
    dict(
...
work_dir = 'work_dirs2/aug3_ablation/v_ratio_1.0_limt_142_0_k'
auto_resume = False
gpu_ids = [1]
