...
log_level = 'INFO'
load_from = None
resume_from = '/home/duomeitinrfx/users/pengxl/mmdetection/tools/work_dirs2/aug4_ablation/2_c300_lim100/epoch_9.pth'
workflow = [('train', 1)]
...
train_pipeline = [
    dict(type='LoadImageFromFile', ratiov=1.0, ratioc=300, limt=100),
...
work_dir = 'work_dirs2/aug4_ablation/2_c300_lim100'
auto_resume = False
gpu_ids = [3]
