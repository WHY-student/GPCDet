...
#albu_train_transforms = [
 #   dict(type='HueSaturationValue', hue_shift_limit=(-2,-2),sat_shift_limit=(9.5,9.5), val_shift_limit=(16,16),p=1.0),
 #   dict(type='RandomBrightnessContrast',p=1,brightness_limit=(0,0),contrast_limit=(0.02,0.02))
#]

train_pipeline = [ # 训练流程
    dict(type='LoadImageFromFile',aug=True,ratiov=1.0,ratioc=300,limt=100),   # 第 1 个流程，从文件路径里加载图像
...
test_pipeline = [
    dict(type='LoadImageFromFile',aug=True,ratiov=1.0,ratioc=300,limt=100),
    dict(
