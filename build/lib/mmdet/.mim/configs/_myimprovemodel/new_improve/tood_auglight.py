...
#albu_train_transforms = [
 ...
 #   dict(type='RandomBrightnessContrast',p=1,brightness_limit=(0.1,0),contrast_limit=(0.02,0.02))
#]

train_pipeline = [ # 训练流程
    dict(type='LoadImageFromFile',aug=True,percent=2,light_limt=300),   # 第 1 个流程，从文件路径里加载图像
