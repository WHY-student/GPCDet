...
class TOODHeadATTENTION(ATSSHead):
    ...
    def __init__(self,
        ...
        super(TOODHeadATTENTION, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        if self.attention=='CALayer':
            for i in range(0,5):
                attention_=CALayer(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='MS_CAM':
            for i in range(0,5):
                attention_=MS_CAM(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='CBAM':
            for i in range(0,5):
                attention_=CBAMLayer(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='CA': # Coordinate Attention
            for i in range(0,5):
                attention_=CA(inp=self.in_channels,oup=self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='ShuffleAttention':
            for i in range(0,5):
                attention_=ShuffleAttention(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='CrissCrossAttention':
            for i in range(0,5):
                attention_=CrissCrossAttention(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='NAMAttention':
            for i in range(0,5):
                attention_ = NAMAttention(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='SKAttention':
            for i in range(0,5):
                attention_ = SKAttention(self.in_channels)
                self.attentions.append(attention_)
            ...
            for i in range(0,5):
                attention_ = S2Attention(self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='GAMAttention':
            for i in range(0,5):
                attention_ = GAMAttention(c1=self.in_channels,c2=self.in_channels)
                self.attentions.append(attention_)
        elif self.attention=='BAM':
            for i in range(0,5):
                attention_ = BAMBlock(channel=self.in_channels)
                self.attentions.append(attention_)
