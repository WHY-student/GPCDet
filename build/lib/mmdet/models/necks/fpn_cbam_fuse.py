...
class FPN_CBAM_FUSE(BaseModule):
    """
# 这是一个例子
    Example:
        >>> import torch
    ...
    def __init__(self,
        ...
        super(FPN_CBAM_FUSE, self).__init__(init_cfg)
        ...
        self.cbam=CBAMLayer(self.out_channels)
    ...
    def forward(self, inputs): # 这里输入是backbone传来的4层的张量，只用到后三层
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            if 'scale_factor' in self.upsample_cfg:
                ...
                laterals[i - 1] = laterals[i - 1] + self.cbam(F.interpolate(
