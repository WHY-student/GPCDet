...
def parse_args():
    ...
    parser.add_argument('--img', default='/home/duomeitinrfx/data/tangka_magic_instrument/update/coco_0.8_0.2/val',help='Image file')
    parser.add_argument('--config',default='/home/duomeitinrfx/users/pengxl/mmdetection/configs/_myimprovemodel/new_improve/tood_ca.py', help='Config file')
    parser.add_argument('--checkpoint',default='/home/duomeitinrfx/users/pengxl/mmdetection/tools/work_dirs_0.8_0.2/1000_1300_dcn/prio_gcn_ca/tood/tood_lr0.6_1/best_bbox_mAP_epoch_23.pth', help='Checkpoint file')
    parser.add_argument(
        '--method',
        default='eigencam',
    ...
    parser.add_argument(
        '--target-layers',
        default=['neck.fpn_convs[0]','neck.fpn_convs[1]'],
        nargs='+',
        type=str,
    ...
    parser.add_argument('--out-dir', help='dir to output file')
...
def main():
    ...
    image_paths =file_name(images)
    save_path = "/home/duomeitinrfx/users/pengxl/mmdetection/tools/work_dirs_0.8_0.2/1000_1300_dcn/prio_gcn_ca/tood/tood_lr0.6_1/heapmap/eigencam/fpn0_1"

    for image_path in image_paths:
        image_name = image_path.split("/")[-1].split(".")[0]
        image_heapmap=save_path+"/"+image_name
        image = cv2.imread(image_path)
