...
def parse_args():
    ...
    parser.add_argument('--config',default='/home/pengxl/mycode/mmdetection/configs/detectors/detectors_cascade_rcnn_r50_1x_coco.py', help='test config file path')
    parser.add_argument(
        '--prediction_path', default='/home/pengxl/mycode/mmdetection/tools/work_dirs/detectors_cascade_rcnn_r50_1x_coco/result.pkl', help='prediction path where test pkl result')
    parser.add_argument(
        '--show_dir',default='/home/pengxl/mycode/mmdetection/tools/work_dirs/detectors_cascade_rcnn_r50_1x_coco/save ',help='directory where painted images will be saved')
