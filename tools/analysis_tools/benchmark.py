...
def parse_args():
    ...
    parser.add_argument('--config',default="/home/duomeitinrfx/users/pengxl/mmdetection/tools/work_dirs_0.8_0.2/1000_1300/tood/tood/tood_fpn.py" ,help='test config file path')
