...
def parse_args():
    ...
    # parser.add_argument('--config', default='../configs/_myimprovemodel/new_improve/tood_gcn_ca_factoratt.py',
    #                         help='train config file path')
    parser.add_argument('--config', default='../configs/sparse_rcnn/sparse_rcnn_r50_fpn_1x_coco.py',
                        help='train config file path')
    # 在训练期间，日志文件和 checkpoint 文件将会被保存在工作目录下，它需要通过配置文件中的 work_dir 或者 CLI 参数中的 --work-dir 来指定。


    # parser.add_argument('--work-dir', default='work_dirs_0.8_0.2/1000_1300_dcn/factor_all/new/detach_1.0',help='the dir to save logs and models')
    parser.add_argument('--work-dir', default='work_dirs_0.8_0.2/1000_1300_dcn/compare/sparse_3.5e-5',
