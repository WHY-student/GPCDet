...
class MyCOCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[4] = _summarize(1, areaRng='normal', maxDets=self.params.maxDets[2])
            ...
            stats[9] = _summarize(0, areaRng='normal', maxDets=self.params.maxDets[2])
            return stats
        if not self.eval:
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 96 ** 2], [96 ** 2, 1e5 ** 2]]
        self.areaRngLbl = ['all', 'small','normal']
        self.useCats = 1
