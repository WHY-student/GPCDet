...
def voc_classes():
    return [
        "sword","Ruyi Bao","Precious mirror","Pipa","Bowl","Buddhist abbot's staff", "Scripture","pagoda","beads", "vajra Pestle",
...
def imagenet_vid_classes():
    return [
        "sword", "Ruyi Bao", "Precious mirror", "Pipa", "Bowl", "Buddhist abbot's staff", "Scripture", "pagoda",
        "beads", "vajra Pestle",
        "vajra bell", "Karma pestle", "Yak tail dusting", "Peacock feather fan and mirror", "canopy", "flag"
    ]
