...
class TaskAlignedAssigner(BaseAssigner):
    ...
    def __init__(self, topk, iou_calculator=dict(type='BboxOverlaps2D'),assign_metric='iou'):
        assert topk >= 1
        self.topk = topk
    ...
    def assign(self,
        ...
        assigned_gt_inds[max_overlaps != -INF] = argmax_overlaps[max_overlaps != -INF] + 1  #最大iou不为inf 将这个anchor与其最大的IOU的gt赋予下标(gt+1) 正样本
