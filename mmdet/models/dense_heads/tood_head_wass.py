...
class RFTOODHead(ATSSHead):
    ...
    def __init__(self,
        ...
        super(RFTOODHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def loss_single2(self, cls_score, bbox_pred, anchors, labels, label_weights,
    ...
    def loss(self,
        ...
        if self.epoch < self.initial_epoch:
            ...
            anchor_list, valid_flag_list = self.get_anchors(
                featmap_sizes, img_metas, device=device)
            label_channels = self.cls_out_channels if self.use_sigmoid_cls else 1
            cls_reg_targets = self.get_targets2(
                anchor_list,
                valid_flag_list,
                gt_bboxes,
                img_metas,
