...
from ..utils.attention import CoordAtt_forbfhead
...
class TaskDecomposition(nn.Module):
    ...
    def forward(self, feat, avg_feat=None):
        ...
        conv_weight = conv_weight.reshape(b, self.feat_channels,
                                          self.in_channels)
        # weight用来调整 reduce的卷积核权重，实现不同通道加权
        ...
        # n*1024*H*W --->n*256*H*W
        return feat


@HEADS.register_module()
class TOODHeadCA(ATSSHead):
    ...
    def __init__(self,
        ...
        super(TOODHeadCA, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.ca=CoordAtt_forbfhead(self.in_channels)
        ...
        self.tood_cls = nn.Conv2d(
            self.feat_channels,
            self.num_base_priors * self.cls_out_channels,# 16(不包括一个背景类)
            3,
            padding=1)
