...
train_pipeline = [ # 训练流程
    dict(type='LoadImageFromFile',aug=True,percent=0,light_limt=100,sig=10),   # 第 1 个流程，从文件路径里加载图像
    dict(type='LoadAnnotations', with_bbox=True),   # 第 2 个流程，对于当前图像，加载它的注释信息
    dict(type='Resize',  # 变化图像和其注释大小的数据增强的流程。
         img_scale=(1000, 1300),  # 图像的最大规模
         #img_scale=(1333, 800),
...
test_pipeline = [
    dict(type='LoadImageFromFile',aug=True,percent=0,light_limt=100,sig=10),
    dict(
...
data = dict(
    ...
    train=dict(
        ...
        #img_prefix=data_root + 'train_95_epoch2/',
    ...
    val=dict(
        ...
        #img_prefix=data_root + 'val_95_epoch2/',
...
#     dict(type='Resize', img_scale=(1000, 1300), keep_ratio=True),
...
#                  'canopy', 'flag'),
#         ann_file=
#         '/home/duomeitinrfx/data/tangka_magic_instrument/update/coco_0.8_0.2/annotations/instances_train.json',
#         img_prefix=
#         '/home/duomeitinrfx/data/tangka_magic_instrument/update/coco_0.8_0.2/train/',
#         pipeline=[
#             dict(type='LoadImageFromFile'),
#             dict(type='LoadAnnotations', with_bbox=True),
#             dict(type='Resize', img_scale=(1000, 1300), keep_ratio=True),
...
#                  'canopy', 'flag'),
#         ann_file=
#         '/home/duomeitinrfx/data/tangka_magic_instrument/update/coco_0.8_0.2/annotations/instances_val.json',
#         img_prefix=
#         '/home/duomeitinrfx/data/tangka_magic_instrument/update/coco_0.8_0.2/val/',
#         pipeline=[
#             dict(type='LoadImageFromFile'),
#             dict(
#                 type='MultiScaleFlipAug',
