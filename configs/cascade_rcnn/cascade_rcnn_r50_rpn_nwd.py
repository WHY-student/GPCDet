...
Average Precision  (AP) @[ IoU=0.50      | area=   all | maxDets=1500 ] = 0.442
Average Precision  (AP) @[ IoU=0.75      | area=   all | maxDets=1500 ] = 0.129
...
Average Precision  (AP) @[ IoU=0.50:0.95 | area=medium | maxDets=1500 ] = 0.356
...
Average Recall     (AR) @[ IoU=0.50:0.95 | area=  tiny | maxDets=1500 ] = 0.309
Average Recall     (AR) @[ IoU=0.50:0.95 | area= small | maxDets=1500 ] = 0.377
Average Recall     (AR) @[ IoU=0.50:0.95 | area=medium | maxDets=1500 ] = 0.441
...
Optimal LRP FN          @[ IoU=0.50      | area=   all | maxDets=1500 ] = 0.534
# Class-specific LRP-Optimal Thresholds # 
 [0.466 0.484 0.479 0.564 0.401 0.442 0.382 0.11 ]

+----------+-------+---------------+-------+--------------+-------+
| category | AP    | category      | AP    | category     | AP    |
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.247 | bridge        | 0.120 | storage-tank | 0.326 |
| ship     | 0.345 | swimming-pool | 0.116 | vehicle      | 0.231 |
| person   | 0.080 | wind-mill     | 0.033 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+

+----------+-------+---------------+-------+--------------+-------+
| category | oLRP  | category      | oLRP  | category     | oLRP  |
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.790 | bridge        | 0.888 | storage-tank | 0.718 |
| ship     | 0.709 | swimming-pool | 0.896 | vehicle      | 0.802 |
| person   | 0.924 | wind-mill     | 0.964 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+
